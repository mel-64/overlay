...
# renovate: datasource=forgejo-tags depName=mergiraf/mergiraf packageName=mergiraf/mergiraf registryUrl=https://codeberg.org
...
SRC_URI="
	https://codeberg.org/mergiraf/mergiraf/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
