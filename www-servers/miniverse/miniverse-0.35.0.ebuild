...
# renovate: datasource=github-tags depName=svenstaro/miniserve
...
SRC_URI="
	https://github.com/svenstaro/miniserve/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"

S="${WORKDIR}/miniserve-0.35.0"
LICENSE="MIT"
