...
# renovate: datasource=github-tags depName=est31/cargo-udeps
...
CRATES="
	...
	byteorder@1.5.0
	bytes@1.11.1
	cargo-credential-libsecret@0.5.6
	cargo-credential-macos-keychain@0.4.21
	cargo-credential-wincred@0.4.21
	cargo-credential@0.4.10
...
SRC_URI="
	https://github.com/est31/cargo-udeps/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
